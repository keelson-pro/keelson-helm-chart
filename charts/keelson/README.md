...
highest Z.** For a chart whose `appVersion` is `1.23`:

| Cluster | Suitable package versions                   | Recommended   |
|---------|---------------------------------------------|---------------|
| `1.35`  | `1.23.1.34.Z`, `1.23.1.35.Z`, `1.23.1.36.Z` | `1.23.1.36.Z` |
| `1.36`  | `1.23.1.35.Z`, `1.23.1.36.Z`, `1.23.1.37.Z` | `1.23.1.37.Z` |
